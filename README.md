...
|----------|--------|-----|-------|---------|--------|
| **Version**  |  <p style="text-align: center; margin: 0">48+</p>    | <p style="text-align: center; margin: 0">11+</p> | <p style="text-align: center; margin: 0">25+</p>   | <p style="text-align: center; margin: 0">40+</p>     | <p style="text-align: center; margin: 0">9+</p>     |
| **Checked**  | <p style="text-align: center; margin: 5px 0 0 0"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" width=18px alt="chrome" /></p> | <p style="text-align: center; margin: 5px 0 0 0"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" width=18px alt="chrome" /></p> | <p style="text-align: center; margin: 5px 0 0 0"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" width=18px alt="chrome" /></p> | <p style="text-align: center; margin: 5px 0 0 0"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" width=18px alt="chrome" /></p> | <p style="text-align: center; margin: 5px 0 0 0"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg"  width=18px alt="chrome" /></p> |
