...
|----------|--------|-----|-------|---------|--------|
| **Version**  |  <div style="text-align: center;">48+</div>    | <div style="text-align: center;">11+</div> | <div style="text-align: center;">25+</div>   | <div style="text-align: center;">40+</div>     | <div style="text-align: center;">9+</div>     |
| **Checked**  | <div style="text-align: center;"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" style="margin-top: 6px" width=18px alt="chrome" /></div> | <div style="text-align: center;"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" style="margin-top: 6px; " width=18px alt="chrome" /></div> | <div style="text-align: center;"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" style="margin-top: 6px" width=18px alt="chrome" /></div> | <div style="text-align: center;"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" style="margin-top: 6px" width=18px alt="chrome" /></div> | <div style="text-align: center;"><img src="https://raw.githubusercontent.com/biscuit-js/biscuit-store/HEAD/docs/assets/check.svg" style="margin-top: 6px" width=18px alt="chrome" /></div> |
