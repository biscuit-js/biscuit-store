 ...
 * @public
 */
export function subscribeToState(action, fn = () => { }) {
    const theat = Promise;
    try {
        actionError(action);
 ...
 * @public
 */
export function subscribeToStore(repo, fn = () => { }) {
    const theat = Promise;
    try {
...
export function manager(action) {
    ...
    return {
         ...
         * @param {object{repo: string, state: string}} targetAction the action that you want to merge
         * @public
         */
         ...
         * @param {object{repo: string, state: string}} targetAction the action that you want to compare
         * @return {bool}
         * @public
         */
