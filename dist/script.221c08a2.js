...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../packages/core/src/internal/repositories.js":[function(require,module,exports) {
"use strict";
...
},{}],"../packages/core/src/internal/debugger.js":[function(require,module,exports) {
"use strict";
...
},{"./repositories":"../packages/core/src/internal/repositories.js"}],"../packages/core/src/internal/messages.js":[function(require,module,exports) {
"use strict";
...
},{}],"../packages/core/src/internal/emitter.js":[function(require,module,exports) {
"use strict";
...
},{"./debugger":"../packages/core/src/internal/debugger.js","./messages":"../packages/core/src/internal/messages.js"}],"../packages/core/src/internal/helper.js":[function(require,module,exports) {
"use strict";
...
},{"./repositories":"../packages/core/src/internal/repositories.js","./debugger":"../packages/core/src/internal/debugger.js","./messages":"../packages/core/src/internal/messages.js"}],"../packages/core/src/internal/dispatch.js":[function(require,module,exports) {
"use strict";
...
},{"./repositories":"../packages/core/src/internal/repositories.js","./helper":"../packages/core/src/internal/helper.js","./emitter":"../packages/core/src/internal/emitter.js"}],"../packages/core/src/internal/utils.js":[function(require,module,exports) {
"use strict";
...
},{}],"../packages/core/src/internal/store.js":[function(require,module,exports) {
"use strict";
...
},{"./repositories":"../packages/core/src/internal/repositories.js","./emitter":"../packages/core/src/internal/emitter.js","./helper":"../packages/core/src/internal/helper.js","./dispatch":"../packages/core/src/internal/dispatch.js","./debugger":"../packages/core/src/internal/debugger.js","./utils":"../packages/core/src/internal/utils.js","./messages":"../packages/core/src/internal/messages.js"}],"../packages/core/src/internal/creator.js":[function(require,module,exports) {
"use strict";
...
},{"./debugger":"../packages/core/src/internal/debugger.js","./repositories":"../packages/core/src/internal/repositories.js","./store":"../packages/core/src/internal/store.js","./utils":"../packages/core/src/internal/utils.js","./helper":"../packages/core/src/internal/helper.js","./messages":"../packages/core/src/internal/messages.js"}],"../packages/core/src/index.js":[function(require,module,exports) {
"use strict";
...
},{"./internal/creator":"../packages/core/src/internal/creator.js","./internal/store":"../packages/core/src/internal/store.js"}],"script.ts":[function(require,module,exports) {
"use strict";
...
src_1.middleware(store).add(function (context, next) {
  console.log('context', context);
  next();
});
src_1.createDebuger(store, function (e) {
  console.log(e);
});
store.subscribe(function (state) {
  console.log(state);
});
src_1.subscribeToState(actions.testAdd, function (state) {
  console.log(state);
});
src_1.subscribeToStore('user', function (state) {
  console.log(state);
});
...
src_1.dispatch(actions.testAdd, {
  value: 2
}).before(function (state) {
  console.log(state);
});
src_1.dispatch(actions.testAdd, function (prev) {
  return {
    value: prev.value += 999
  };
});
console.log(actions.testAdd.getState().value);
console.log(src_1.getState(actions.testAdd).value);
console.log(src_1.getRepo('user').value);
src_1.addRepo('user', {
  id: 2
});
var superAction = src_1.createStateTo(store).bind('SUPER/ACTION');
console.log(superAction);
var actionCollection = src_1.initialActions(src_1.createStateTo(store), [{
  name: 'FIRST/ACTION',
  options: {
    branch: true,
    initial: {
...
var collection = src_1.stateCollection();
...
var collection1 = src_1.stateCollection();
collection1.compile(actions.testStep);
var combineCollection = src_1.combineStateCollections(collection, collection1);
console.log('sss', combineCollection.all());
src_1.manager(actions.testStep).merge();
console.log('compare instance', src_1.manager(actions.testStep).compareRepoWithInstance({
  value: 0,
  id: 2,
  name: 'fill'
}));
console.log('1111111', src_1.getRepo('user'));
src_1.addRepo('user', {
  result: 999
});
console.log('not pull', src_1.getState(actions.testStep));
src_1.manager(actions.testStep).pull();
console.log('pull', src_1.getState(actions.testStep)); // manager(actions.testStep).remove();

src_1.manager(actions.testStep).clone('cloneuser');
console.log('get clone', src_1.getRepo('cloneuser'));
},{"../packages/core/src":"../packages/core/src/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
