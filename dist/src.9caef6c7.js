 ...
 * @return {import('../types').StoreParams} returns a set of actions
 * @public
 */
...
},{"./debugger":"../src/core/debugger.js","./repositories":"../src/core/repositories.js","./store":"../src/core/store.js","./utils":"../src/core/utils.js"}],"../src/types/types.ts":[function(require,module,exports) {
"use strict";
...
var Biscuit = __importStar(require("../core/creator"));

function createStore(options) {
  return Biscuit.createStore(options);
}

exports.createStore = createStore;
;
},{"../core/creator":"../src/core/creator.js"}],"../src/index.ts":[function(require,module,exports) {
"use strict";
...
actions.testStart.dispatch({
  value: 2
});
},{"./types/types":"../src/types/types.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
