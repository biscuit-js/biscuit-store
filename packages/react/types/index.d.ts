 ...
 * @public
 */
declare function useSubscribe<S = any>(
	action: Dep<S>, update?: boolean
): [S, Dispatch];
 ...
 */
declare function useDispatch<S = any>(...actions: DepsAction<S>): Dispatch[];
 ...
 * @return dispatch list
 */
declare function useDispatchThrottle<S = any>(
	action: AnyAction<S>,
	count: number
): ModifyDispatch;
 ...
 * @return dispatch list
 */
declare function useDispatchDebounce<S = any>(
	action: AnyAction<S>,
	count: number,
	immediate: boolean
): ModifyDispatch;
 ...
 * @return methods
 */
declare function listen<S, P = any>(
	event: StateAction<S> | Store,
	exp: S
): {
	/**
