...
it('manager test compareStates', () => {
    ...
    expect(
        createManager(actions.testBranch7)
            .compareStates(actions.testBranch8)
    ).toBe(true);

    expect(
        createManager(actions.testBranch3)
            .compareStates(actions.testBranch8)
    ).toBe(false);
});
...
it('manager test compareStateWithInstance', () => {
    ...
    expect(manager.compareStateWithInstance({ data: 123, value: 3 })).toBe(true);
...
it('manager test compareStoreWithInstance', () => {
    ...
    expect(manager.compareStoreWithInstance({ data: 123, value: 3 })).toBe(false);
});
